...
function activate(context) {
  ...
  let fileEvents = [vscode.workspace.createFileSystemWatcher('**/.luacheckrc')]

  vscode.workspace.getConfiguration("lua-tools").get("filesWithCoverage", "").split(",").forEach((file) => {
    fileEvents.push(vscode.workspace.createFileSystemWatcher('**/' + file))
  })
  ...
  let disposable = new vscode_languageclient.LanguageClient('lua-tools', 'lua-tools', serverOptions, clientOptions).start();
